...
export const modules = [
  ...
  },
  {
    ...
    label: "CRM",
    icon: ContactRound,
    copy: "Acompanhe oportunidades e próximos contatos.",
    action: "Novo contato",
  },
  {
    slug: "pacientes",
    label: "Pacientes",
    icon: UsersRound,
    copy: "Centralize histórico e informações dos pacientes.",
  ...
  },
  {
    ...
    label: "Avaliações",
    icon: Star,
    copy: "Registre avaliações, planos e evoluções.",
  ...
  },
  {
    ...
    label: "Propostas",
    icon: FileText,
    copy: "Crie e acompanhe propostas comerciais.",
  ...
  },
  {
    ...
    label: "Vendas",
    icon: ShoppingBag,
    copy: "Visualize negociações e conversões.",
  ...
  },
  {
    ...
    label: "Pacotes",
    icon: PackageOpen,
    copy: "Monte combinações de procedimentos.",
    action: "Novo pacote",
  },
  {
    slug: "assinaturas",
    label: "Assinaturas",
    icon: Repeat2,
    copy: "Gerencie planos recorrentes da clínica.",
  ...
  },
  {
    ...
    label: "Financeiro",
    icon: WalletCards,
    copy: "Controle entradas, saídas e recebíveis.",
  ...
  },
  {
    ...
    label: "Automações",
    icon: Workflow,
    copy: "Configure lembretes e jornadas automáticas.",
  ...
  },
  {
    ...
    label: "Relatórios",
    icon: BarChart3,
    copy: "Analise resultados clínicos e comerciais.",
